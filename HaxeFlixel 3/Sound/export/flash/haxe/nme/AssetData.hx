...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("Shoot", nme.NME_assets_sounds_shoot_mp3);
			type.set ("Shoot", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("Death", nme.NME_assets_sounds_death_mp3);
			type.set ("Death", Reflect.field (AssetType, "sound".toUpperCase ()));
			...
			className.set ("assets/sounds/death.mp3", nme.NME_assets_sounds_death_mp4);
			type.set ("assets/sounds/death.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			className.set ("assets/sounds/shoot.mp3", nme.NME_assets_sounds_shoot_mp4);
...
class NME_assets_sounds_shoot_mp3 extends flash.media.Sound { }
class NME_assets_sounds_death_mp3 extends flash.media.Sound { }
...
class NME_assets_sounds_death_mp4 extends flash.media.Sound { }
class NME_assets_sounds_shoot_mp4 extends flash.media.Sound { }
