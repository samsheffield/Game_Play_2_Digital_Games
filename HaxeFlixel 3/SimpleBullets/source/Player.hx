...
class Player extends FlxSprite {
	...
	override public function update():Void {
		...
		// Fire Bullet by adding it to bullets FlxGroup in Screen1
		if(FlxG.keys.justPressed("SPACE") == true){
			// Add a new Bullet to the group when a SPACE was pressed
			cast(FlxG.state, Screen1).bullets.add(new Bullet(x+20, y-20)); // Offset the position of the Bullet
		}
