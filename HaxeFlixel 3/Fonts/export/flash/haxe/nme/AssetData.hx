...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/SourceCodePro-Light.ttf", nme.NME_assets_sourcecodepro_light_ttf);
			type.set ("assets/SourceCodePro-Light.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
...
class NME_assets_sourcecodepro_light_ttf extends flash.text.Font { }
