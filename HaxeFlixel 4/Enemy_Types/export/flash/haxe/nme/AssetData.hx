...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("Shoot", nme.NME_assets_shoot_mp3);
			type.set ("Shoot", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("Explode", nme.NME_assets_death_mp3);
			...
			className.set ("assets/shoot.mp3", nme.NME_assets_shoot_mp4);
...
class NME_assets_shoot_mp4 extends flash.media.Sound { }
