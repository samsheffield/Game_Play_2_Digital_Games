...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("BackgroundMusic", nme.NME_assets_jingle_wav);
			type.set ("BackgroundMusic", Reflect.field (AssetType, "sound".toUpperCase ()));
			...
			className.set ("assets/jingle.mp3", nme.NME_assets_jingle_mp3);
			type.set ("assets/jingle.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
...
class NME_assets_jingle_wav extends flash.media.Sound { }
...
class NME_assets_jingle_mp3 extends flash.media.Sound { }
