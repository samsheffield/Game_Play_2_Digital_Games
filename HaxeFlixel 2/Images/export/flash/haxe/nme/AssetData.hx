...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/bgImage.png", nme.NME_assets_bgimage_png);
			type.set ("assets/bgImage.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			className.set ("assets/player1.png", nme.NME_assets_player1_png);
			type.set ("assets/player1.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_bgimage_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
...
class NME_assets_player1_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
